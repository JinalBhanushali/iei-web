   ...
   <div id="main-section">
                        ...
                        <div className="box-heading">
                          ...
                          <div className=""> 
                              ...
                              <div className="box-text">
                                  ...
                                  <p>“Make it work, make it right, make it fast"  The entire family of IEI Student Chapter,
                                    A.D. Patel Institute of Technology, CVM University feels highly ecstatic as it brings 
                                you an enlightening webinar on Competitive Programming We are tremendously elated as we 
                                introduce Mr. Harsh Bardhan Mishra. he is an MLH Fellow and a Technical Content Reviewer  
                                 Intern at GeeksforGeeks.Moreover he has also been a part of Microsoft Learn student ambassador
                                 and student partner programs.</p>
                                  <p>
                                  <img src={arrow} alt="" className="arrow-icon"/> &nbsp; Date : 24th October 2020 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
                                  <img src={arrow} alt="" className="arrow-icon"/> &nbsp;&nbsp; Topic: Competitive Programming</p>
                                  <p>
                                  <img src={arrow} alt="" className="arrow-icon"/>
                                  &nbsp;&nbsp; Webinar Platform : Google Meet &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                  <img src={arrow} alt="" className="arrow-icon"/>
                                   &nbsp;&nbsp; Registration Link :  <a href="http://bit.ly/competitive-programming_iei">http://bit.ly/competitive-programming_iei</a> </p>
                             </div>
                        </div> 
        ...
        <div className=""> 
            ...
            <div className="box-text">
                <p><i className="fa fa-quote-left" aria-hidden="true"></i> Make it work, make it right, make it fast"  The entire family of IEI Student Chapter,
                    ...
                    introduce Mr. Harsh Bardhan Mishra. he is an MLH Fellow and a Technical Content Reviewer  
                    Intern at GeeksforGeeks.Moreover he has also been a part of Microsoft Learn student ambassador
                    and student partner programs. <i class="fa fa-quote-right" aria-hidden="true"></i>
                </p>
                <p><img src={arrow} alt="" className="arrow-icon"/>
                        &nbsp; Date : 24th October 2020
                </p>
                <p><img src={arrow} alt="" className="arrow-icon"/>
                ...
                <p><img src={arrow} alt="" className="arrow-icon"/>
                        &nbsp; Registration Link : <a className="" href="http://bit.ly/competitive-programming_iei">http://bit.ly/competitive-programming_iei</a> 
                </p>
            </div>
        </div> 
    </div>
    <div className="box">
      ...
      <div  className="">
            ...
            <div className="box-text">
                <p><i className="fa fa-quote-left" aria-hidden="true"></i> The greatest enemy of knowledge is not ignorance, it is the illusion of knowledge." The entire family of brings to you an 
                                 enormously informative workshop on "Development cycle   IEI Student Chapter, A.D. Patel Institute of Technology, CVM University 
                               feels highly rhapsodic as it of Machine  brings to you an enormously informative workshop on "Development cycle Learning Project." We are tremendously ecstatic as we introduce  Mr. Krish Naik
                             as the speaker for this event. He is currently serving as the Lead Data  Scientist at iNeuron Academy and Panasonic Indian Innovation Center. Moreover, 
                               he has also been part of HCL Technologies as a Software Engineer. Apart from all this, he also runs a Youtube Channel, "Krish Naik" with over 237k+ subscribers.<i className="fa fa-quote-right" aria-hidden="true"></i>
                </p>
                <p>
                   <img src={arrow} alt="" className="arrow-icon"/>&nbsp; Date: 29th September 2020  
                </p>
                <p>
                    <img src={arrow} alt="" className="arrow-icon"/>&nbsp;Time: 10:00 AM IST
                </p>
                <p>
                   <img src={arrow} alt="" className="arrow-icon"/>&nbsp; Session length: 2 hours
                </p>
                <p>
                   <img src={arrow} alt="" className="arrow-icon"/>&nbsp; Platform: Google Meet
                </p>
                <p>
                    <img src={arrow} alt="" className="arrow-icon"/>&nbsp; Registration Link: <a href="https://forms.gle/xBKykbxCqgumSxsL6">https://forms.gle/xBKykbxCqgumSxsL6</a> 
                </p>
            </div>
        </div>
    </div>
